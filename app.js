...
const drawGame =() =>{
    ...
    mesg.innerText= `Game is draw...Try again `;
...
const showWinner =(userWin, userChoice,compChoice) =>{
    if(userWin){
        ...
        // console.log("You Win!")
        mesg.innerText= `You win game! ${userChoice} beats ${compChoice}`;
        mesg.style.backgroundColor = "green";
    } else{
        compScore++;
        compScorePara.innerText = compScore;
        // console.log("You lose the game")
        mesg.innerText =`You lose the game! ${compChoice} beats your ${userChoice}`;
